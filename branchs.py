...
# Definição da DAG
dag = DAG('branchtest', description='dag pbranchtest',
...
branch_task = BranchPythonOperator(task_id='branch_task', python_callable=avalia_numero_aleatorio, provide_context=True, dag=dag)
